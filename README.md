...
- Native Settings dialog for dotfile/generated-folder visibility, initial tree scan entries, editable file size, workspace search caps, current-file search caps, and UI result counts.
